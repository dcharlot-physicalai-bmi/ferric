...
//! stateless prefill (`Qwen3::forward` for llama / qwen2 / qwen3, `Qwen35::forward` for the
//! gated-delta-net hybrids — dispatched on the file's `general.architecture`), and prints per
...
use ferric_llama::{qwen3::Qwen3, qwen35::Qwen35};
use std::sync::Arc;
