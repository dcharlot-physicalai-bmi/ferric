...
//!
//! Run: `cargo run -p ferric-tensor --example ebm_arm3c --release`
...
async fn run() {
    ...
    println!("     discrete two-stage argmin          {:>4.0}%         152          BIGGER VALUE: HV=128, 20k FVI (96/14k gave 0-4%)", rd as f32 / n as f32 * 100.0);
