...
fn lcg(s: &mut u64) -> f32 {
    *s = s.wrapping_mul(6364136223846793005).wrapping_add(1442695040888963407);
    // ⛔ `>> 33` gave [-1, 0) -- ALL-NEGATIVE activations -- until 2026-09-04. The energy numbers
    // this file produced were measured on a one-signed input vector; see the commit that fixed it.
